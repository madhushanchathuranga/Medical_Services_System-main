...
<?php
	...
	if(isset($_POST['saveBtn'])) {
        ...
        $queryDocId = "SELECT id FROM `nurse` ORDER BY `id` DESC LIMIT 1";
        ...
        $qurey = "INSERT INTO `nurse` VALUES ('{$nrsId}','{$fName}','{$lName}','{$email}','{$mobile}','{$dept}',0)";
        ...
        if ($result) {
            ...
            $qurey = "INSERT INTO `user`(`id`,`username`, `password`, `role`) VALUES ('{$nrsId}','{$email}','{$pwd}','nurse')";
            ...
            <main class="page-content">
                <div class="container">
                    ...
                    <div class="row topic">
                        ...
                        <div class="col-md-11">
                            <span class="font-weight-bold"><big>Add Nurse</big><br><small>Nurse</small></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 form">
                            <a href="nurseList.php" ><button type="button" class="btn btn-outline-primary"><i class="fas fa-list"></i>  Nurse List</button></a>
                            <br><hr><br>
                            <!-- Form -->
