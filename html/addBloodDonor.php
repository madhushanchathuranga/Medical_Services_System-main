...
<?php
	...
	if(isset($_POST['saveBtn'])) {
        ...
        $queryDocId = "SELECT id FROM `blooddonor` ORDER BY `id` DESC LIMIT 1";
        ...
        if (mysqli_num_rows($result_set) == 1) {
            ...
            $num = substr($lastId['id'],2,strlen($lastId['id']));
        ...
        $qurey = "INSERT INTO `blooddonor` VALUES ('{$bldId}','{$fName}','{$lName}','{$gender}','{$age}','{$address}','{$mobile}','{$blood}',0)";
            ...
            <main class="page-content">
                <div class="container">
                    ...
                    <div class="row topic">
                        ...
                        <div class="col-md-11">
                            <span class="font-weight-bold"><big>Add Blood Donor</big><br><small>Blood Doner</small></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 form">
                            <a href="bloodDonor.php" ><button type="button" class="btn btn-outline-primary"><i class="fas fa-list"></i>  Blood Doner List</button></a>
                            <br><hr><br>
                            <!-- Form -->
                            <form action="addBloodDonor.php" method="post">
