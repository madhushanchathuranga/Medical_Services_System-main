        ...
        <nav class="navbar navbar-expand-sm navbar-dark">
            <div class="container-fluid">
                <div class="navbar-header">
                    <a class="navbar-brand" href="../../index_en.php"><img id="logo" src="../../images/logoc.png">CareHome Online consulting system</a>
                </div>
                <ul class="nav navbar-nav navbar-right lead">
                    ...
                    <li class="nav-item active"><a class="nav-link" href="doctor_en.php">DOCTORS</a></li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="depList col-lg-3 col-md-3 col-sm-12 col-12 mt-5 mb-5">
                            <div class="py-5 px-2">
                                <h5 class="mb-4">DEPARTMENT OF</h5>
                                    <?php
                                    ...
                                    if (mysqli_num_rows($result_set) >= 1) {
                                        ...
                                        echo "<p><a href='doctor_en.php?id=12345}'><hr><i class='fas fa-angle-double-right'></i> All Departments<hr></a></p>";

                                        while($deptName = mysqli_fetch_assoc($result_set)){
                                            echo "<p><a href='doctor_en.php?id={$deptName['id']}'><hr><i class='fas fa-angle-double-right'></i> ".$deptName['name']."<hr></a></p>";
                                        }
