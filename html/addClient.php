...
<?php
	...
	if(isset($_POST['saveBtn'])) {
        ...
        $qurey = "INSERT INTO `client` VALUES ('{$acnId}','{$fName}','{$lName}','{$email}','{$mobile}',0)";
        ...
        if ($result) {
            ...
            $qurey = "INSERT INTO `user`(`id`,`username`, `password`, `role`) VALUES ('{$acnId}','{$email}','{$pwd}','client')";
            ...
            <main class="page-content">
                <div class="container">
                    ...
                    <div class="row topic">
                        ...
                        <div class="col-md-11">
                            <span class="font-weight-bold"><big>Add Client</big><br><small>Client</small></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 form">
                            <a href="clientList.php" ><button type="button" class="btn btn-outline-primary"><i class="fas fa-list"></i>  Client List</button></a>
                            <br><hr><br>
                            <!-- Form -->
