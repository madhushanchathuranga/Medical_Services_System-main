...
<?php
	...
	if(isset($_POST['saveBtn'])) {
        ...
        $queryDocId = "SELECT id FROM `laboratorist` ORDER BY `id` DESC LIMIT 1";
        ...
        $qurey = "INSERT INTO `laboratorist` VALUES ('{$acnId}','{$fName}','{$lName}','{$email}','{$mobile}',0)";
        ...
        if ($result) {
            ...
            $qurey = "INSERT INTO `user`(`id`,`username`, `password`, `role`) VALUES ('{$acnId}','{$email}','{$pwd}','laboratorist')";
            ...
            <main class="page-content">
                <div class="container">
                    ...
                    <div class="row topic">
                        ...
                        <div class="col-md-11">
                            <span class="font-weight-bold"><big>Add Laboratorist</big><br><small>Laboratorist</small></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 form">
                            <a href="laboratoristList.php" ><button type="button" class="btn btn-outline-primary"><i class="fas fa-list"></i>  Laboratorist List</button></a>
                            <br><hr><br>
                            <!-- Form -->
                            <form action="addLaboratorist.php" method="post">
