...
<?php
	...
	if(isset($_POST['saveBtn'])) {
        ...
        $queryDocId = "SELECT id FROM `accountant` ORDER BY `id` DESC LIMIT 1";
        ...
        $qurey = "INSERT INTO `accountant` VALUES ('{$acnId}','{$fName}','{$lName}','{$email}','{$mobile}',0)";
        ...
        if ($result) {
            ...
            $qurey = "INSERT INTO `user`(`id`,`username`, `password`, `role`) VALUES ('{$acnId}','{$email}','{$pwd}','accountant')";
            ...
            <main class="page-content">
                <div class="container">
                    ...
                    <div class="row topic">
                        ...
                        <div class="col-md-11">
                            <span class="font-weight-bold"><big>Add Accountant</big><br><small>Accountant</small></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 form">
                            <a href="accountantList.php" ><button type="button" class="btn btn-outline-primary"><i class="fas fa-list"></i>  Accountant List</button></a>
                            <br><hr><br>
                            <!-- Form -->
                            <form action="addAccountant.php" method="post">
